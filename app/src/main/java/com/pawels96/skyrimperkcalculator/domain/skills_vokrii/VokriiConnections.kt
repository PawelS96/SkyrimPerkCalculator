 ...
 fun EMainSkill.getVokriiConnections(): Map<IPerk, Array<IPerk>>{
    ...
    when (this) {
        EMainSkill.SKILL_HEAVY_ARMOR -> {
            ...
            map[VOK_HAR_BATTLE_FATIGUE] = arrayOf(VOK_HAR_IMMOVABLE_OBJECT)
            ...
            map[VOK_HAR_IMMOVABLE_OBJECT] = arrayOf(VOK_HAR_REAP_THE_WHIRLWIND)
        ...
        EMainSkill.SKILL_DESTRUCTION -> {
            map[VOK_DES_DESTRUCTION_MASTERY] = arrayOf(VOK_DES_DESTRUCTION_DUAL_CASTING, VOK_DES_AUGMENTED_FLAMES, VOK_DES_AUGMENTED_FROST, VOK_DES_AUGMENTED_SHOCK, VOK_DES_RUNE_MASTER, VOK_DES_RAW_POWER)
        ...
        EMainSkill.SKILL_SMITHING -> {
            map[VOK_SMT_STEEL_SMITHING] = arrayOf(VOK_SMT_DWARVEN_SMITHING, VOK_SMT_ARMOR_PADDING, VOK_SMT_ARCANE_BLACKSMITH, VOK_SMT_ELVEN_SMITHING)
            map[VOK_SMT_DWARVEN_SMITHING] = arrayOf(VOK_SMT_ORCISH_SMITHING)
            map[VOK_SMT_ORCISH_SMITHING] = arrayOf(VOK_SMT_EBONY_SMITHING, VOK_SMT_HIGH_YIELD_MINING)
            map[VOK_SMT_EBONY_SMITHING] = arrayOf(VOK_SMT_DAEDRIC_SMITHING)
            ...
            map[VOK_SMT_ELVEN_SMITHING] = arrayOf(VOK_SMT_ADVANCED_ARMORS)
            map[VOK_SMT_ADVANCED_ARMORS] = arrayOf(VOK_SMT_HIGH_YIELD_MINING, VOK_SMT_GLASS_SMITHING)
            map[VOK_SMT_GLASS_SMITHING] = arrayOf(VOK_SMT_DRAGON_SMITHING)
        }
