...
public enum Vok_HeavyArmor implements IPerk {

    VOK_HAR_HEAVY_ARMOR_MASTERY (0.5f, 0.95f, 0, 20, 40, 60, 80),
    ...
    VOK_HAR_OFF_BALANCE (0.1f, 0.5f, 40),
    ...
    Vok_HeavyArmor(float x, float y, int... skill) {
