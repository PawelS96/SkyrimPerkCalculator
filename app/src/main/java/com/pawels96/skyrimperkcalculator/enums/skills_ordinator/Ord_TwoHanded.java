...
public enum Ord_TwoHanded implements IPerk {

    ORD_TWH_TWO_HANDED_MASTERY                  (0.5f ,    0.95f ,  20,40),
    ORD_TWH_TRAINED_FIGHTER                     (0.1f ,   0.8f ,  20),
    ORD_TWH_BLEED_LIKE_A_DOG                    (0.3f ,    0.75f ,  30,50,70),
    ORD_TWH_CLASH_OF_HEROES                     (0.65f ,    0.75f ,  30,50,70),
    ORD_TWH_CRUSHING_BLOWS                      (0.5f ,   0.8f ,   30,50,70),
    ORD_TWH_BATTER                              (0.5f ,   0.65f ,  40,60),
    ORD_TWH_FEROCIOUS_STRENGTH                  (0.8f ,    0.8f ,   40),
    ORD_TWH_MAUL                                (0.675f ,    0.6f ,  40,60),
    ORD_TWH_RIVE                                (0.3f ,    0.6f ,   40,60),
    ...
    Ord_TwoHanded(float x, float y, int... skill) {
