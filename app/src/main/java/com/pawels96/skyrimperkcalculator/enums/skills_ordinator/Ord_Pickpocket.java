...
public enum Ord_Pickpocket implements IPerk {

    ORD_PCK_PICKPOCKET_MASTERY         (0.5f ,   0.95f ,  20,40),
    ...
    ORD_PCK_DEATHS_EMPEROR             (0.8f ,   0.6f ,   40,60),
    ...
    Ord_Pickpocket(float x, float y, int... skill) {
