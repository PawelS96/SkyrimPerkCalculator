...
public enum Ord_Conjuration implements IPerk {
   ...
   ORD_CON_REAP_AND_SOW                      (0.45f,   0.5f ,   40,60),
   ...
   ORD_CON_SKELETON_MAGES                    (0.5f,    0.3f ,   50,70),
